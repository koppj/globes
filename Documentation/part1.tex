...
rule {\tt rule}. These parameters can take the value \GLBC{GLB\_ALL} to specify that
...
\hspace*{0.5 cm}                                                                \\
\hspace*{0.5 cm}      /* Assign complete chi\textasciicircum2 to first experiment */ \\
\hspace*{0.5 cm}      if (glbGetCurrentExp() != 0)  return 0;                   \\
\hspace*{0.5 cm}                                                                \\
