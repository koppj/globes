...
\end{center}
\mycaption{\label{fig:reactor} The result from {\tt example5.c} (figure similar in \Ref~\cite{Huber:2006vr}). The fat curve corresponds to the systematics on page~\pageref{ex:syst}.}
\end{figure}
