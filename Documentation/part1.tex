...
%
Since the pre-defined experiments in \tabl{experiments} are given for specfific luminosities, it is useful to change these parameters of the
...
$\hat{\rho_i}$, \index{Density scaling factor} 
