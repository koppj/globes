...
to \GLB{SetRates}. This has to be done {\em before} any evaluation 
...
\index{norm}{Correlations!multi-parameter}
...
\index{norm}{Priors} 
\index{norm}{Input errors} 
\index{norm}{Starting values}
...
Gaussian {\em priors}: We assume that an external measurement has 
determined the measured parameter to be at the central value 
(which we call {\em starting value}) with a $1 \sigma$ Gaussian error 
...
addition of Gaussian so-called {\em priors} to the systematics-minimized 
