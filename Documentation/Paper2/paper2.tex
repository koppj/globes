...
a simulation tool for short- and long-baseline neutrino oscillation experiments. As new features, \GLOBESN\ allows for user-defined systematical errors, which can also be used to simulate experiments with
