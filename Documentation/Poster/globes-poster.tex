...
\newcommand{\mytitlebox}[4]{%
  \begin{tikzpicture}%
    ...
    \draw[color=headingframe,line width=7pt,fill=headingbg,rounded corners=0.8cm]%
      (1.5cm, #2+1.2cm) node [anchor=center,color=black] at (#1/2, #2-0.1cm) {\Large\bf #3}
...
\begin{center}
  \hspace*{1cm}
  \mybox{45cm}{11.5cm}{
    GLoBES is a modular open-source software library for simulating of short-
    ...
    \begin{minipage}[t]{21cm}
      ...
      \begin{itemize}
        ...
        \item Peform sophisticated $\chi^2$ analyses
...
\begin{center}
  ...
  \mytitlebox{27cm}{42cm}{Experiment definition in GLoBES}{
    ...
    \begin{minipage}[T]{11.5cm}
      ...
      \vspace{-7.5cm}
      \cutout{r}(12.5cm,-9.0cm) \shapepar[30cm]{\circleshape}
  ...
  \mytitlebox{18cm}{42cm}{Oscillations}{
    ...
    \begin{itemize}
      ...
      \item \emph{High numerical efficiency} \\
        ...
        ensure an excellent performance, which is, for the speicif
  ...
  \mytitlebox{27cm}{42cm}{$\chi^2$ analysis}{
    ...
    \end{itemize}
    The builtin $\chi^2$ function of GLoBES have the Poissonian form
    \begin{align*}
      \chi^2(\vec{\lambda}, \vec{a})
        =& 2 \sum_{exp's} \sum_{\rm rules} \sum_{bins}
          \Bigg[
    ...
    \hspace*{0.5cm} \includegraphics[width=25.5cm]{projex}
    \vspace{-1cm}
  }
  \hspace*{1cm}
\end{center}
...
\begin{center}
  ...
  \mytitlebox{24cm}{36cm}{Recent GLoBES results}{
    ...
    \begin{tabular}{l@{\hspace{1.0cm}}l}
      Evolution of $\sin^2 2\theta_{13}$ disc.~reach
    &
      $\delta_{CP}$ sensitivity of different exp's \hfill
    \\
      \vspace{2cm}
      \includegraphics[width=11cm]{disclimitbandnova}
    &
      \includegraphics[width=11cm]{deltacp}
    \\
      \parbox{11cm}{Impact of systematical errors in a reactor experiment}
    &
      \parbox{11cm}{Sensitivity of a $\nu$-fact to standard and non-standard physics}
    \\
      \includegraphics[width=11cm]{systematics}
    &
      \includegraphics[width=11cm]{bar-chart}
    \end{tabular}
  }
  \hspace*{1cm}
\end{center}
