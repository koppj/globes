...
double square(double x){return x*x; }
 ...
 /* user-defined implementation of the GLoBES standard priors */
double my_prior(const glb_params in, void* user_data)
{
  ...
  if(glbGetProjectionFlag(p,i)==GLB_FREE)
  {
   ...
   if(inputerror>1e-8)
    pv+=square((fitvalue-centralvalue)/inputerror);
  }
  ...
  /* Add additional contributions to prior value pv here: */


  /* .... */

 
  /* End additional contributions */
