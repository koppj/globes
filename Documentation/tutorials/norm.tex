...
the input flux files for use in \AEDL\ experiment descriptions. This
version describes globes versions 3.0 and later.
\end{abstract}
...
given cross section\footnote{The cross section which come with
  \GLOBES\ always are per nucleon.}) per unit target mass $m_u$ (which usually is {\it
...
\begin{eqnarray}
\mathtt{@norm}=\left(\frac{\mathrm{GeV}}{\Delta
      E}\right)
