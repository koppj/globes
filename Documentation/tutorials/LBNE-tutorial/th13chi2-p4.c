 ...
 *                                                                         *
 * Solution to problem 4: Code is similar to th13chi2.c, but with a        *
 * different starting value for the minimization                           *
 ***************************************************************************/
...
int main(int argc, char *argv[])
{
  ...
  for(x=x_lower; x <= x_upper+0.00001; x+=delta_x)
  {
    ...
    glbSetOscParams(test_values, M_PI/2.0, GLB_DELTA_CP);
