...
called {\tt globes}\index{norm}{globes@{\tt globes}}, which can be seen either as a 
crude \AEDL\ debugger 
...
The {\tt globes}\index{norm}{globes@{\tt globes}} binary is installed along 
with the library \index{norm}{libglobes@{\tt libglobes}}, but
