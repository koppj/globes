...
software package, which allows the simulation of future long-baseline
...
beam and full detector simulations as accurate as possible. For the
definition of experiments, a new transparent building block concept is introduced. In addition, a binary provides the possibility to test
new experiment definitions quickly.
%
Another
part of \GLOBES\ is the user's interface, which provides probability, rate, and $\Delta \chi^2$ information for a given experiment or any
combination of up to 32 experiments. Especially, the
...
parameters, external input, and matter density uncertainties. Eventually,
many systematics options are provided, such as normalization and energy
...
We would like to thank Martin Freund and Andrea Romanino ???
for initiating this project many years ago with one of the first
neutrino factory simulations. In addition, we would like to thank
Marc Rolinec for the help to translate the experiment descriptions
...
for many years, to the ones who have been continuing asking for the publication of the software, and the referees of several of our
