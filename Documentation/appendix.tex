...
T2K & {\tt T2K.glb} & 2~yr $\nu$/6~yr $\bar{\nu}$ & 0.77~MW & 295~km & WC & 22.5~kt \\ \hline
T2HK & {\tt T2HK.glb} & 4~yr $\nu$/4~yr $\bar{\nu}$ & 4~MW & 295~km & WC & 500~kt \\ \hline
NO$\nu$A & {\tt NOvA.glb} & 3~yr $\nu$/3~yr $\bar{\nu}$ & 1.12~MW & 812~km & TASD & 25~kt \\ \hline
...
Small & {\tt Reactor1.glb} & 5~yr $\bar{\nu}$ & 4~GW & 1.7~km & LS & 20~t \\ \hline
Large & {\tt Reactor.glb} & 8~yr $\bar{\nu}$ & 10~GW & 1.7~km & LS & 100~t \\ \hline
DoubleCHOOZ & {\tt D-Chooz\_near.glb} & 5~yr $\bar{\nu}$ & 2$\times$4.2~GW & 0.1~km & LS & 10.16~t \\ 
...
Low $\gamma$ & {\tt BB\_100.glb} & 4~yr $\nu$/4~yr $\bar{\nu}$ & 100 & 130~km & WC & 500~kt \\ \hline
Medium $\gamma$ & {\tt BB\_350.glb} & 4~yr $\nu$/4~yr $\bar{\nu}$ & 350 & 730~km & WC & 500kt \\  \hline
Variable & {\tt BBvar\_WC.glb} & 4~yr $\nu$/4~yr $\bar{\nu}$ & variable & variable & WC & 500~kt \\  \hline
Variable & {\tt BBvar\_TASD.glb} & 4~yr $\nu$/4~yr $\bar{\nu}$ & variable & variable & TASD & 50~kt \\ 
\end{tabular}
\end{center}
...
Standard & {\tt NFstandard.glb} & \begin{tabular}{l}4~yr $\nu$ \\ 4~yr $\bar{\nu}$\end{tabular} & 50~GeV & 3000~km & \begin{tabular}{l}MID\end{tabular} & \begin{tabular}{l}50~kt\end{tabular} \\ \hline
Variable & {\tt NFvar.glb} & \begin{tabular}{l}4~yr $\nu$ \\ 4~yr $\bar{\nu}$\end{tabular} & variable & variable & \begin{tabular}{l}MID\end{tabular} & \begin{tabular}{l}50~kt\end{tabular} \\ \hline
Silver & {\tt NF\_GoldSilver.glb} & \begin{tabular}{l}4~yr $\nu$ \\ 4~yr $\bar{\nu}$\end{tabular} & variable & variable
&\begin{tabular}{l}MID\\ECC\end{tabular}&\begin{tabular}{l}50~kt\\5~kt\end{tabular}\\ \hline
Hybrid & {\tt NF\_hR\_lT.glb} & \begin{tabular}{l}4~yr $\nu$ \\ 4~yr $\bar{\nu}$\end{tabular} & variable & variable & \begin{tabular}{l}Hybrid\end{tabular} & \begin{tabular}{l}50~kt\end{tabular} \\ 
\end{tabular}
\end{center}
...
\subsection*{Variable Feutrino Factory -- {\tt NFvar.glb}}
...
$\mathrm{10\,GeV\lesssim E_\mu\lesssim 80\, GeV}$ (technically it is possible to arrange {\tt emax} for $\mathrm{E_\mu=5\,
GeV}$). The baseline of the scenario is L~=~{\tt BASELINE} and has to be chosen within the interval $\mathrm{1\,km\lesssim\, L \, \lesssim\, 2\cdot R_{EARTH}}$. 
