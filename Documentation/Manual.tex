...
\usepackage{hyperref}
\hypersetup{colorlinks,citecolor=red,filecolor=red,linkcolor=blue,urlcolor=green}
...
\begin{center}
{\large Patrick Huber$^a$, Joachim Kopp$^b$, Manfred Lindner$^c$, \\ Walter Winter$^d$}
\end{center}
...
\begin{center}
Version from \today\ for \GLOBES\ 3.2.18
\end{center}
...
{\em\small $^{\mathrm{a}}$%
       Virginia Tech, Center for Neutrino Physics, Blacksburg, VA 24061, USA}

{\em\small $^{\mathrm{b}}$%
  Theoretical Physics Department,
  CERN and Johannes Gutenberg University Mainz (Germany),
...
\bigskip
\begin{quote}
    Copyright \copyright  2004--2020  The GLoBES Team.
...
Comput. Phys. Commun. 177 (2007) 432, arXiv:\glbxxxtwo,
\end{quote}
...
\section*{Version 3.2.18}
\index{norm}{Version 3.2.18}

\begin{itemize}

  \item Systematics correlated across experiments/detector; see
    \Sec~\ref{sec:newsys}. This feature has been extensively tested
    and used, amongst others, for the DUNE CDR~\cite{Acciarri:2015uup}.
\item Fitting of actual data; see \Sec~\ref{sec:fitting}.
\end{itemize}
...
\item US Department of Energy under award number \protect{DE-SC0003915} [PH]
\end{itemize}
