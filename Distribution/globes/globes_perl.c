 ...
 * $Header: /home/lin/globes/cvs-noaccess/Projects/GLOBES/Distribution/globes/globes_perl.c,v 1.9 2006/02/21 20:32:02 globes Exp $
 * ----------------------------------------------------------------------------- */
...
#define  SWIGTYPE_glb_dlhandle swig_types[1] 
#define  SWIGTYPE_p_p_char swig_types[2] 
#define  SWIGTYPE_p_glb_exp swig_types[3] 
#define  SWIGTYPE_p_f_a___double__double swig_types[4] 
#define  SWIGTYPE_p_double swig_types[5] 
#define  SWIGTYPE_glb_exp swig_types[6] 
#define  SWIGTYPE_p_p_double swig_types[7] 
#define  SWIGTYPE_p_size_t swig_types[8] 
#define  SWIGTYPE_glb_params swig_types[9] 
#define  SWIGTYPE_p_void swig_types[10] 
#define  SWIGTYPE_glb_projection swig_types[11] 
...
XS(_wrap_glbSetExperiment) {
    {
        ...
        {
            if (SWIG_ConvertPtr(ST(0), (void **) &arg1, SWIGTYPE_glb_exp,0) < 0) {
                SWIG_croak("Type error in argument 1 of glbSetExperiment. Expected _glb_exp");
            }
        }
...
XS(_wrap_glbDefaultExp) {
    {
        ...
        {
            if (SWIG_ConvertPtr(ST(0), (void **) &arg1, SWIGTYPE_glb_exp,0) < 0) {
                SWIG_croak("Type error in argument 1 of glbDefaultExp. Expected _glb_exp");
            }
        }
...
XS(_wrap_glbInitExp) {
    {
        ...
        {
            if (SWIG_ConvertPtr(ST(0), (void **) &arg1, SWIGTYPE_glb_exp,0) < 0) {
                SWIG_croak("Type error in argument 1 of glbInitExp. Expected _glb_exp");
            }
        }
        glbInitExp(arg1);
...
XS(_wrap_glbAllocExp) {
    {
        ...
        ST(argvi) = sv_newmortal();
        SWIG_MakePtr(ST(argvi++), (void *) result, SWIGTYPE_glb_exp, 0|SWIG_OWNER);
        XSRETURN(argvi);
        fail:
        ;
    }
...
XS(_wrap_glbFreeExp) {
    {
        ...
        {
            if (SWIG_ConvertPtr(ST(0), (void **) &arg1, SWIGTYPE_glb_exp,0) < 0) {
                SWIG_croak("Type error in argument 1 of glbFreeExp. Expected _glb_exp");
            }
        }
        glbFreeExp(arg1);
...
XS(_wrap_glbOpenModule) {
    {
        ...
        ST(argvi) = sv_newmortal();
        SWIG_MakePtr(ST(argvi++), (void *) result, SWIGTYPE_glb_dlhandle, 0|SWIG_OWNER);
        XSRETURN(argvi);
        fail:
        ;
    }
...
XS(_wrap_glbCloseModule) {
    {
        ...
        {
            if (SWIG_ConvertPtr(ST(0), (void **) &arg1, SWIGTYPE_glb_dlhandle,0) < 0) {
                SWIG_croak("Type error in argument 1 of glbCloseModule. Expected _glb_dlhandle");
            }
        }
...
XS(_wrap_glbSymModule) {
    {
        ...
        {
            if (SWIG_ConvertPtr(ST(0), (void **) &arg1, SWIGTYPE_glb_dlhandle,0) < 0) {
                SWIG_croak("Type error in argument 1 of glbSymModule. Expected _glb_dlhandle");
            }
        }
        if (!SvOK((SV*) ST(1))) arg2 = 0;
        else arg2 = (char *) SvPV(ST(1), PL_na);
...
XS(_wrap_glbUsePrior) {
    {
        ...
        {
            if (SWIG_ConvertPtr(ST(0), (void **) &arg1, SWIGTYPE_glb_dlhandle,0) < 0) {
                SWIG_croak("Type error in argument 1 of glbUsePrior. Expected _glb_dlhandle");
            }
        }
...
static swig_type_info _swigt__glb_dlhandle[] = {{"_glb_dlhandle", 0, "glb_dlhandle", 0},{"_glb_dlhandle"},{0}};
static swig_type_info _swigt__p_p_char[] = {{"_p_p_char", 0, "char **", 0},{"_p_p_char"},{0}};
static swig_type_info _swigt__p_glb_exp[] = {{"_p_glb_exp", 0, "glb_exp *", 0},{"_p_glb_exp"},{0}};
static swig_type_info _swigt__p_f_a___double__double[] = {{"_p_f_a___double__double", 0, "double (*)(double [])", 0},{"_p_f_a___double__double"},{0}};
static swig_type_info _swigt__p_double[] = {{"_p_double", 0, "double *", 0},{"_p_double"},{0}};
static swig_type_info _swigt__glb_exp[] = {{"_glb_exp", 0, "glb_exp", 0},{"_glb_exp"},{0}};
