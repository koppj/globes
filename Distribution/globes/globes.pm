...
*glbGetChannelBin = *globesc::glbGetChannelBin;
...
*glbGetSignalBinInRule = *globesc::glbGetSignalBinInRule;
*glbGetBackgroundBinInRule = *globesc::glbGetBackgroundBinInRule;
*glbGetObservedBinInRule = *globesc::glbGetObservedBinInRule;
