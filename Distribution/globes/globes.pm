...
*glbDefineOscEngine = *globesc::glbDefineOscEngine;
...
*glbSetInitialStep = *globesc::glbSetInitialStep;
...
*MAX_FLAVORS = *globesc::MAX_FLAVORS;
*MAX_INTERACTIONS = *globesc::MAX_INTERACTIONS;
*GLB_EFT_L = *globesc::GLB_EFT_L;
*GLB_EFT_R = *globesc::GLB_EFT_R;
*GLB_EFT_S = *globesc::GLB_EFT_S;
*GLB_EFT_P = *globesc::GLB_EFT_P;
*GLB_EFT_T = *globesc::GLB_EFT_T;
*GLB_EFT_N_LORENTZ_STRUCTURES = *globesc::GLB_EFT_N_LORENTZ_STRUCTURES;
1;
