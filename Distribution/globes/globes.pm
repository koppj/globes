...
*glbSetRatesInExperiment = *globesc::glbSetRatesInExperiment;
...
*glbCosThetaToL = *globesc::glbCosThetaToL;
*glbLToCosTheta = *globesc::glbLToCosTheta;
...
*glbRegisterNuSQuIDSEngine = *globesc::glbRegisterNuSQuIDSEngine;
...
*GLB_NU_E = *globesc::GLB_NU_E;
*GLB_NU_MU = *globesc::GLB_NU_MU;
*GLB_NU_TAU = *globesc::GLB_NU_TAU;
...
*GLB_BINNING_E_ONLY = *globesc::GLB_BINNING_E_ONLY;
*GLB_BINNING_E_L = *globesc::GLB_BINNING_E_L;
*GLB_BINNING_E_COS_THETA = *globesc::GLB_BINNING_E_COS_THETA;
*GLB_N_BINNING_TYPES = *globesc::GLB_N_BINNING_TYPES;
...
*GLB_ATM_THICKNESS = *globesc::GLB_ATM_THICKNESS;
...
*GLB_SET_RATES_TRUE = *globesc::GLB_SET_RATES_TRUE;
*GLB_SET_RATES_TEST = *globesc::GLB_SET_RATES_TEST;
*GLB_SET_RATES_SLOW = *globesc::GLB_SET_RATES_SLOW;
*GLB_SET_RATES_FAST = *globesc::GLB_SET_RATES_FAST;
