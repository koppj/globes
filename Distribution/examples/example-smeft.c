...
{ 
  ...
  printf("E=%g, prod. coeff=(%g %g %g %g %g)\n",
         E,
         glbEFTFluxCoeff(0, 0, GLB_EFT_V, E),
         glbEFTFluxCoeff(0, 0, GLB_EFT_A, E),
         glbEFTFluxCoeff(0, 0, GLB_EFT_S, E),
         glbEFTFluxCoeff(0, 0, GLB_EFT_P, E),
         glbEFTFluxCoeff(0, 0, GLB_EFT_T, E));
  printf("E=%g, det. coeff=(%g %g %g %g %g)\n",
         E,
         glbEFTXSecCoeff(0, 0, GLB_EFT_V, E),
         glbEFTXSecCoeff(0, 0, GLB_EFT_A, E),
         glbEFTXSecCoeff(0, 0, GLB_EFT_S, E),
         glbEFTXSecCoeff(0, 0, GLB_EFT_P, E),
         glbEFTXSecCoeff(0, 0, GLB_EFT_T, E));
  getchar();
