...
/* Define to 1 if you have the <gsl/gsl_sf_erf.h> header file. */
#define HAVE_GSL_GSL_SF_ERF_H 1
...
/* Name of package */
#define PACKAGE "globes"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "globes@mpi-hd.mpg.de"

/* Define to the full name of this package. */
#define PACKAGE_NAME "GLoBES"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "GLoBES 3.2.0alpha"
...
#define PACKAGE_VERSION "3.2.0alpha"
